...
<table class="form-table">
	...
	<tr class="form-field">
		<th scope="row" valign="top"><label for="impress_agents_taxonomy[id]"><?php _e( 'ID', 'impress_agents' ); ?></label></th>
		<td>
	...
	<tr class="form-field">
		<th scope="row" valign="top"><label for="impress_agents_taxonomy[name]"><?php _e( 'Plural Name', 'impress_agents' ); ?></label></th>
		...
		<p class="description"><?php _e( 'Example: "Job Types" or "Offices"', 'impress_agents' ); ?></p></td>
	</tr>

	<tr class="form-field">
		<th scope="row" valign="top"><label for="impress_agents_taxonomy[singular_name]"><?php _e( 'Singular Name', 'impress_agents' ); ?></label></th>
		...
		<p class="description"><?php _e( 'Example: "Job Type" or "Office"', 'impress_agents' ); ?></p></td>
	</tr>
